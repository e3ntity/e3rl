...
from e3rl.algorithms import Agent
...
class Runner:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Args:
            environment (e3rl.env.VecEnv): The environment to run the agent in.
            agent (e3rl.algorithms.agent): The RL agent to run.
        ...
        self._git_status_repos = [e3rl.__file__]
